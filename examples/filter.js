...
function (_React$Component) {
  ...
  function Demo() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSelect", function () {// use onChange instead
      // console.log(arguments);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDataChange", function () {
      var simpleTreeData = _this.state.simpleTreeData;
