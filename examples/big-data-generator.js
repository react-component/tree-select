    ...
    return (<div style={{ padding: '0 20px' }}>
      ...
      <form onSubmit={this.onGen}>
        <span style={{ marginRight: 10 }}>
          x: <input ref={this.xRef} defaultValue={x} type="number" min="1" required style={{ width: 50 }} />
        </span>
        <span style={{ marginRight: 10 }}>
          y: <input ref={this.yRef} defaultValue={y} type="number" min="1" required style={{ width: 50 }} />
        </span>
        <span style={{ marginRight: 10 }}>
          z: <input ref={this.zRef} defaultValue={z} type="number" min="1" required style={{ width: 50 }} />
        </span>
